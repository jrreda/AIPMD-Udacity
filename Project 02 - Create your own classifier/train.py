...
#         Choose architecture: python train.py ./flowers -a densenet121 
#                              python train.py ./flowers -a vgg16 -s ../ImageClassifier/
#         Set hyperparameters: python train.py ./flowers -a vgg19 -lr 0.0001 -hu 2048 1024 -do 0.6 0.4 -e 2
#         Use GPU for training: python train.py ./flowers -a densenet201 -cuda True
...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--epochs', default=1, type=int)                                  # 1 for testing
    ...
    # save a checkpoint
    save_checkpoint(args.save_dir, model, optimizer, image_datasets, arch=args.arch,
                    hidden_units=args.hidden_units, dropouts=args.dropouts, epochs=args.epochs)
