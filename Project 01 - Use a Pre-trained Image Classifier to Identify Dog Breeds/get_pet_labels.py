...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(filenames), 1):
       ...
       if filenames[idx][0] != ".":
           ...
           # then Splits lower case string by _ to break into words 
           word_list_pet_image = filenames[idx].lower().split("_")

           # Creates temporary label variable to hold pet label name extracted 
           pet_label = ""

           # Loops to check if word in pet name is alphabetic characters - 
           # if true append to pet_label separated by trailing 
...
get_pet_labels("/home/workspace/pet_images")